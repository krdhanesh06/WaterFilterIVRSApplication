...
public class CallRecorder extends AppCompatActivity {
    ...
    private void RequestPermissions() {
        ActivityCompat.requestPermissions(CallRecorder.this, new String[]{RECORD_AUDIO, WRITE_EXTERNAL_STORAGE}, REQUEST_AUDIO_PERMISSION_CODE);
    }
    public void Back(View view) {
        Intent i = new Intent(CallRecorder.this, LanguagesActivity.class);
        startActivity(i);
    }
    public void Next(View view) {
        Intent i = new Intent(CallRecorder.this, DialerActivity.class);
        startActivity(i);
    }
